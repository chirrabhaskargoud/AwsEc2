...
public class EC2Commands {
	...
	static String keyName = "chirra";
	static String sgName = "default";
	
	public static void main(String[] args) {
		amazonEC2Client = AmazonEC2ClientBuilder.standard().withRegion("us-east-1").build();
...
//		terminateInstance();
	...
	static void createInstance(){
		RunInstancesRequest run = new RunInstancesRequest();
 	    run.withImageId("ami-0cff7528ff583bf9a").withInstanceType("t2.micro").withMinCount(1).withMaxCount(1).withKeyName(keyName).withSecurityGroups(sgName);
